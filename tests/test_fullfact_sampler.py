...
def test_create_and_run_lhs_sampler(yaml_file ='tests/data/test_fullfact_sampler.yaml'):
...
if __name__ == '__main__':
    test_create_and_run_lhs_sampler(yaml_file='data/test_fullfact_sampler.yaml')
    pass